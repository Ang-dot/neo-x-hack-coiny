...
const GameHistory = ({ gameID, gameDetails, setIsModalOpen }) => {
    ...
    // const [isInstagramBtnClick, setIsInstagramBtnClick] = useState(false);
    ...
    //         setStatus('Creating Instagram post...');
    ...
    //         if (data.success) {
    //             setStatus('Successfully shared to Instagram!');
    //             setCaption('');
    //             // Close modal after short delay
    //             setTimeout(() => {
    //                 setIsInstagramBtnClick(false);
    //                 setStatus('');
    //             }, 2000);
    //         } else {
    //             setStatus(`Error: ${data.message}`);
    ...
    //         setStatus('Error posting to Instagram');
    //     }
    // };
    ...
    return (
        <div className="max-w-4xl mx-auto pt-20">
            ...
            {/* <div className="flex flex-row justify-between mb-4">
                ...
                <button
                    onClick={() => setIsInstagramBtnClick(true)}
            ...
            {/* {isInstagramBtnClick && (
                <div className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-8">
                    <div className="relative bg-[#0A0B1E] rounded-lg max-w-2xl w-full shadow-2xl p-8">
                        <button
                            onClick={() => setIsInstagramBtnClick(false)}
                            className="absolute right-4 top-4 text-gray-400 hover:text-white transition-colors"
                        >
                            <X size={24} />
                        </button>
                        ...
                        <div className="p-6">
                            <h2 className="font-pressStart2P pb-4">Add Instagram Caption (Optional)</h2>
                            <textarea
                                value={caption}
                                onChange={(e) => setCaption(e.target.value)}
                                className="w-full p-2 border rounded text-black"
                                placeholder="Add caption text (optional)"
                                rows="4"

      ...
      <main className="relative min-h-screen w-full">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              backgroundImage: "url('/images/gameBackground.webp')",
            }}
          />
          ...
          <div className="flex-1 flex items-center justify-center">
            {!isModalOpen ? (
              <div className="relative flex flex-col items-center justify-center">
                ...
                {/* Subtitle */}
                <h1 className="font-pressStart2P text-gray-300 text-[10px] sm:text-[12px] md:text-[15px] lg:text-[16px] xl:text-[17px] leading-10 text-center pb-4">
                ...
                <div className="flex flex-col md:flex-row gap-8 font-londrina">
                  <button className="pixel-white-btn w-[250px] h-16" onClick={() => {
                    setIsJoinBtnClicked(true);
                  }}>
                    Join Game
                  </button>
                  <button className="pixel-btn w-[250px] h-16" onClick={() => {
                    reset();
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    ...
                    <div className="bg-white rounded-lg w-[32rem] max-w-[90%] shadow-xl transform transition-all">
                      ...
                      <div className="border-t px-6 py-4 flex justify-end space-x-3">
                        <button
                          onClick={() => setIsCreateBtnClicked(false)}
                          className="pixel-white-btn transform transition-transform hover:scale-[1.02]"
                        >
                          Cancel
                        </button>
                  ...
                  <div className="fixed top-0 right-0 z-20 bg-white rounded-lg shadow-lg border border-gray-200 p-4 max-w-sm animate-slide-in-right">
                    <div className="flex items-start">
                      <div className="ml-3 w-150 flex-1 pt-0.5">
                        <h1 className="text-sm font-medium text-gray-900">{toastMessage.title}</h1>
                        <h1 className="mt-1 text-sm text-gray-500">{toastMessage.description}</h1>
                      </div>
                      <button
